...
public class foodsg extends javax.swing.JFrame {

    private String[] imagePaths = {"src\\mygames\\foodimages\\adobo.jpg", "src\\mygames\\foodimages\\burger.jpg", "src\\mygames\\foodimages\\carbonara.jpg", "src\\mygames\\foodimages\\fries.jpg", "src\\mygames\\foodimages\\isaw.jpg", "src\\mygames\\foodimages\\menudo.jpg", "src\\mygames\\foodimages\\pancit.jpg", "src\\mygames\\foodimages\\pizza.jpg", "src\\mygames\\foodimages\\shanghai.jpg", "src\\mygames\\foodimages\\spag.jpg"};
    private String[] answers = {"adobo", "burger", "carbonara", "fries", "isaw", "menudo", "pancit", "pizza", "shanghai", "spaghetti"};
    ...
    timer = new Timer(1000, new ActionListener() {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if (secondsLeft <= 0) {
                ...
                timer.stop();
                JOptionPane.showMessageDialog(foodsg.this, "Time's up!");
                categories categoriesFrame = new categories();
                categoriesFrame.setVisible(true);
                dispose();
            }
...
private void updateCoinsLabel() {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(foodsg.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
